    ...
    return (
      <div className="max-w-xl mx-auto py-12">
        <div className="bg-card border border-border rounded-2xl p-8 text-center space-y-4">
          ...
          <p className="text-muted-foreground text-sm">Connect your Bitcoin wallet to create a TAT meme token — 100% Bitcoin-native.</p>
  ...
  return (
    <div className="max-w-xl mx-auto py-6 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <span className="text-[10px] bg-primary/10 text-primary px-2 py-0.5 rounded-full font-semibold">Pure Bitcoin</span>
      </div>
      ...
      <div className="bg-card border border-border rounded-2xl p-6 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground mt-1">SHA-256 hash inscribed in Bitcoin mainnet OP_RETURN genesis</p>
          </div>
        ...
        <div className="bg-muted/20 rounded-lg p-3 space-y-1 text-xs">
          <div className="flex justify-between"><span className="text-muted-foreground">Protocol</span><span className="text-foreground font-semibold">TAT Protocol — Graduated Rune Architecture</span></div>
